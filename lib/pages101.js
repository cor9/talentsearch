...
const GALLERY_SELECT = [
  ...
  'has_current_rep', 'current_rep_name', 'rep_context',
  'seeking',
...
export async function getSubmissions(eventId) {
  ...
  try {
    const submissions = rows.map(normalizeApplication)
    return { submissions, error: null }
  } catch (err) {
...
function normalizeApplication(app) {
  ...
  return {
    ...
    representation: app.has_current_rep && app.current_rep_name
      ? app.current_rep_name
      : '',
